...
<script lang="ts">
    ...
    let pageTitle = $state('Content Management');
    ...
    const sections = [
        { 
            ...
            icon: 'article',
            subsections: [
                { id: 'all', label: 'All Pages', icon: 'view_list' },
        ...
        { 
            ...
            subsections: [
                ...
                { id: 'uploads', label: 'Recent Uploads', icon: 'upload_file' }
            ]
        },
        { 
            id: 'organization', 
    ...
    const mainContent: Snippet = () => {
        return (
            <div class="content-wrapper">
                ...
                />
                <div class="content-management" bind:this={contentElement}>
