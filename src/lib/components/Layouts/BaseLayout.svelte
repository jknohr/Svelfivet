<script lang="ts">
  ...
  import NavigationBar from '$lib/components/common/organisms/navbar/NavigationBar.svelte';
  import ChatFooter from '$lib/components/common/modules/footers/ChatFooter.svelte';
  import type { ContextState, ContextType, RouteType, ContextRoute, ContextConfig } from '$lib/types/context';
  import type { User } from '$lib/types/user';
  import { contextConfigs } from '$lib/config/navigation/navigation';
  import type { BaseLayoutProps } from '$lib/types/components/layout';
  import type { SvelteComponent } from 'svelte';
  import type { NavigationConfig } from '$lib/types/navigation';

  // Get theme value
  const theme = get(MainTheme);
